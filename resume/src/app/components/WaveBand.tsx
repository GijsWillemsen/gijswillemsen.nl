export function WaveBand() {
  return (
    <div className="relative w-full overflow-hidden" style={{ height: 420 }}>
      ...
      >
        <path
          d="M527.394 227.547C327.29 263.186 0 252.036 0 252.036V487.742L1910.01 483.66V0.00420151C1910.01 0.00420151 1692.17 -0.48818 1553.39 9.18761C1328.15 24.8911 1201.05 56.2815 980.953 106.633C800.557 147.903 709.584 195.098 527.394 227.547Z"
          fill="#000C46"
        />
        <path
