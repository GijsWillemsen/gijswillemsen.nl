  ...
  return (
    <div className="bg-[#181818] min-h-screen text-white/80 font-sans flex flex-col relative overflow-x-hidden pt-20">
      ...
      <div className="max-w-[1400px] mx-auto w-full px-6 sm:px-12 pb-32 flex-grow">
        ...
        {/* Page Header */}
        <div className="mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 font-['Fira_Code',monospace] uppercase tracking-tight">System Profile: Gijs Willemsen</h1>
        ...
        <div className="space-y-16">
          ...
          <section>
            <h2 className="text-2xl text-white font-semibold mb-4 font-['Fira_Code',monospace]"><span className="text-blue-500 mr-2">01.</span>The Origin: Deconstruction & Imaginary Builds</h2>
          ...
          <section>
            <h2 className="text-2xl text-white font-semibold mb-4 font-['Fira_Code',monospace]"><span className="text-blue-500 mr-2">02.</span>The School "Hacking" Era (Groups 3 - 5)</h2>
            <div className="space-y-4 text-white/70 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl text-white font-semibold mb-4 font-['Fira_Code',monospace]"><span className="text-blue-500 mr-2">03.</span>The Lockdown Pivot: Jumping to Software</h2>
            <div className="space-y-4 text-white/70 leading-relaxed">
              ...
              <p>Second, I had to entertain myself, so I watched a ton of YouTube and finally jumped from hardware into software. My first ever coding project was building a voice-activated "Jarvis" from a tutorial. I began to understand it and it worked. I tried to make it "smart" by connecting it to a ChatGPT API, which literally just consisted of me typing <code className="bg-white/10 px-1.5 py-0.5 rounded text-sm font-['Fira_Code',monospace]">API_KEY=xxxxxxx-xxxxxx-xxxxxx</code> at the top of the HTML code. Which is pretty funny to me when i look at it now :)</p>
            </div>
          </section>

          <section>
            <h2 className="text-2xl text-white font-semibold mb-4 font-['Fira_Code',monospace]"><span className="text-blue-500 mr-2">04.</span>Current Pipeline & Future Architecture</h2>
            <div className="space-y-4 text-white/70 leading-relaxed">
              ...
              <div className="space-y-4 mt-4">
                <div className="bg-white/5 border border-white/10 p-5 rounded-xl hover:bg-white/10 transition-colors duration-300">
                  <h3 className="text-white font-bold mb-1">Sable <span className="text-blue-400 text-sm font-normal ml-2 font-['Fira_Code',monospace]">(Active First Big Project)</span></h3>
                ...
                <div className="bg-white/5 border border-white/10 p-5 rounded-xl hover:bg-white/10 transition-colors duration-300">
                  <h3 className="text-white font-bold mb-1">The OID Protocol <span className="text-white/50 text-sm font-normal ml-2 font-['Fira_Code',monospace]">(Idea/Blueprint)</span></h3>
                ...
                <div className="bg-white/5 border border-white/10 p-5 rounded-xl hover:bg-white/10 transition-colors duration-300">
                  <h3 className="text-white font-bold mb-1">Algorithmic Autonomy <span className="text-white/50 text-sm font-normal ml-2 font-['Fira_Code',monospace]">(Idea/Blueprint)</span></h3>
          ...
          <section>
            <h2 className="text-2xl text-white font-semibold mb-4 font-['Fira_Code',monospace]"><span className="text-blue-500 mr-2">05.</span>Operational Infrastructure & The Loop</h2>
            <div className="space-y-4 text-white/70 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl text-white font-semibold mb-4 font-['Fira_Code',monospace]"><span className="text-blue-500 mr-2">06.</span>System Interrupts</h2>
            <div className="space-y-4 text-white/70 leading-relaxed">
